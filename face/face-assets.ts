...
export const VISION_WASM_LOADER_PATH = `${VISION_WASM_PATH}/vision_wasm_internal.js`;
export const VISION_WASM_BINARY_PATH = `${VISION_WASM_PATH}/vision_wasm_internal.wasm`;
